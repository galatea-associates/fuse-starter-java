...
- Run tests and launch Visual VM tool. There should be two new orange icons to the left of Debug: "Run with Visual VM" and "Debug with Visual VM". Click on one of them to run tests and launch Visual VM.
