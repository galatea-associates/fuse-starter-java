                ...
                pushToCloudFoundry(
                    ...
                    manifestChoice: [
                        ...
                        envVars: [
                          ...
                          [key: "JAVA_OPTS", value: "-Dapplication.name=my-fuse-app-${env.GIT_COMMIT} -Dlog4j.configurationFile=log4j2-stdout.yml -javaagent:/BOOT-INF/lib/org.jacoco.agent-0.8.0-runtime.jar=output=tcpserver,address=*,port=6300"]
                        ]
                    ],
