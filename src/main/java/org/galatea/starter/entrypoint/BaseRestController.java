...
public abstract class BaseRestController {
  ...
  protected void processRequestId(final String requestId) {
    //This is a temporary solution for cleaning special characters from the REST request params (and will not fix newlines in the parameters or JSON body being printed by the @Log annotation)
    //Proper fix requires version 2.10.0 or higher of the log4j dependencies.  See Issue #243 for more information.
    if (requestId != null) {
